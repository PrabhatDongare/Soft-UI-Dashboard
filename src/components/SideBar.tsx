    ...
    <>
      <div className="d-flex gap-2 justify-content-center align-items-center">
        <img
          ...
          style={{ height: "35px" }}
        />
        <p className="fs-6 fw-bold text-dark mb-0">Soft UI Dashboard 3</p>
      </div>
      ...
      <div
        ...
        style={{
          height: "1px",
          background:
            "linear-gradient(to left, rgba(224, 224, 225, 0) 0%, rgba(224, 224, 225, 1) 50%, rgba(224, 224, 225, 0) 100%)",
        }}
      ></div>
      ...
      <div className="d-flex flex-column gap-3 text-dark">
        ...
        <div className="ps-2">
          <span
            className="px-2 bg-white border border-white rounded me-3"
        ...
        {/* Tables */}
        <div
          className="bg-white px-2 py-2 border border-white"
          style={{ borderRadius: "10px" }}
        >
          <span
            className="px-2 bg-primary border border-primary me-3"
            style={{
              paddingTop: "6px",
              paddingBottom: "7px",
              borderRadius: "10px",
          ...
          <span style={{ fontSize: "13px", fontWeight: 500 }}>Tables</span>
        </div>
        ...
        <div className="ps-2">
          ...
          <span style={{ fontSize: "13px", fontWeight: 500 }}>Billing</span>
        </div>
        ...
        <div className="ps-2">
          ...
          <span style={{ fontSize: "13px", fontWeight: 500 }}>RTL</span>
        </div>

        <p
          className="mb-0 ps-3"
          style={{ fontSize: "13px", fontWeight: 500, color: "#71717a" }}
        >
          ACCOUNT PAGES
        </p>
        ...
        <div className="ps-2">
          ...
          <span style={{ fontSize: "13px", fontWeight: 500 }}>Sign Up</span>
        </div>
      </div>
    </>
  );
